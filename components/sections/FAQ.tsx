...
const faqs = [
  {
    ...
    a: "Стоимость зависит от площади, состояния квартиры и класса отделки. Эконом — от 17 000 руб./м², стандарт — от 27 000 руб./м², премиум — от 37 000 руб./м². Точную цену назовём после выезда замерщика — это бесплатно.",
  },
  {
