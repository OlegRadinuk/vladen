...
const faqs = [
  {
    ...
    a: "Стоимость зависит от площади, состояния квартиры и класса отделки. Эконом — от 20 000 руб./м², стандарт — от 30 000 руб./м², премиум — от 40 000 руб./м². Точную цену назовём после выезда замерщика — это бесплатно.",
  },
  {
