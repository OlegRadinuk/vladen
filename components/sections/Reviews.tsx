...
function CoverCard({
  ...
  return (
    <motion.div
      ...
      style={{ position: "absolute", width: 400, transformOrigin: offset < 0 ? "right center" : "left center" }}
      className={`bg-[#2a2f35] border border-white/10 rounded-2xl p-7 ${offset !== 0 ? "cursor-pointer" : ""}`}
    >
      <Stars count={review.rating} />
      <p className="text-text-dark text-sm leading-relaxed mt-4 mb-5">
    ...
    <section className="py-20 md:py-28 bg-dark overflow-hidden">
      <Container>
        ...
        <div className="hidden md:block">
          <div className="relative flex justify-center" style={{ height: 420 }}>
