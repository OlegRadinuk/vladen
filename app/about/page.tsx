...
export const metadata: Metadata = {
  ...
  description:
    "ООО «ВЛАДЕН» — компания по ремонту квартир и строительству в Симферополе с 2014 года. Собственная бригада отделочников и строителей, 200+ объектов, официальный договор. Работаем по всему Крыму.",
  keywords: [
...
const team = [
  { name: "Владимир Денисов", role: "Основатель и директор", exp: "12 лет" },
...
const milestones = [
  { year: "2014", event: "Основание компании в Симферополе. Первые объекты — частные дома в Крыму" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <AnimateOnView direction="left">
              ...
              <div className="space-y-4 text-text-muted leading-relaxed">
                ...
                <p>
                  За 12 лет реализовали более 200 объектов: от небольших дач до
