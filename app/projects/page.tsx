...
export const metadata: Metadata = {
  title: "Проекты",
  description:
    "Реализованные строительные проекты компании Владен в Крыму. Дома, ремонты, коммерческие объекты.",
  openGraph: {
    title: "Проекты — Владен",
    description: "Реализованные строительные проекты в Крыму.",
  },
};
