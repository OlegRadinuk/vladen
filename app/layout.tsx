...
export const metadata: Metadata = {
  ...
  description:
    "Ремонт квартир и домов под ключ в Симферополе и Крыму. Дизайнерский ремонт, отделка, строительство. ООО «ВЛАДЕН» — 18 лет опыта, более 200 объектов. Звоните: +7 (978) 717-44-47",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Ремонт квартир и домов под ключ в Крыму. Дизайнерский ремонт, отделка, строительство. 18 лет опыта, 200+ объектов.",
...
const jsonLd = {
  ...
  sameAs: ["https://github.com/OlegRadinuk/vladen"],
};
